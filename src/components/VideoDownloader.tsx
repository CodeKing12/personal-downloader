...
import { fetchPinterestVideo, fetchYouTubeVideo } from '~/lib/video-api'
            ...
            <Container maxW="4xl">
                <Stack gap="8" align="center">
                    ...
                    <Stack gap="4" textAlign="center">
                        ...
                        >
                            Download videos from Pinterest and YouTube quickly and easily. Just paste the video URL and click download.
                        </Text>
                    </Stack>
                                    ...
                                    <form onSubmit={handleSubmit}>
                                        <Flex gap="3" flexDirection={{ base: 'column', sm: 'row' }}>
                                            <Box flex="1" position="relative">
                                                ...
                                                <Input
                                                    ...
                                                    class={css({
                                                        ...
                                                        borderColor: 'gray.6',
                                                        _focus: {
                                                            borderColor: activeTab() === 'pinterest' ? '#E60023' : '#FF0000',
                                            ...
                                            <Button
                                                type="submit"
                                                disabled={loading()}
                                                bg={activeTab() === 'pinterest' ? '#E60023' : '#FF0000'}
                                                color="white"
                                                h="12"
                                                px="6"
                                                fontWeight="semibold"
                                                _hover={{
                                                    bg: activeTab() === 'pinterest' ? '#c5001f' : '#cc0000',
                                                }}
                                                _disabled={{
                                                    opacity: 0.6,
                                                    cursor: 'not-allowed',
                    ...
                    <Box w="full">
                        <Grid columns={{ base: 1, md: 3 }} gap="6">
                            <InstructionCard
                                ...
                                description={`Go to ${activeTab() === 'pinterest' ? 'Pinterest' : 'YouTube'} and copy the video URL from your browser's address bar.`}
                            />
                            <InstructionCard
                                step="2"
                                title="Paste & Click"
